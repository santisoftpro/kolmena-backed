...
<br>
   ...
   <section class = "design" id = "design">
    <div class = "container">
      ...
      <div class = "title">
        <h2>SERVICES</h2>
        <p>standalone systems and hybrid systems</p>
      ...
      <div class = "design-content">
        ...
        <div class = "design-item">
          <div class = "design-img">
            <img src = "new-image/IMG-20231211-WA0020.jpg" alt = "">
            <span><i class = "far fa-heart"></i> 22</span>
            <span>SOLAR HEATING SYSTEM</span>
          </div>
          <div class = "design-title">
            <a href = "#">this is a cost-effective way to generate hot water for your home or hotels.</a>
          </div>
        </div>
        <!-- end of item -->
        <!-- item -->
        <div class = "design-item">
          <div class = "design-img">
            <img src = "new-image/IMG-20231020-WA0000.jpg">
            <span><i class = "far fa-heart"></i> 22</span>
            <span>SOLAR OUTDOOR LIGHTING</span>
          </div>
          <div class = "design-title">
            <a href = "#">smart solar-powered light emitting diode (LED) outdoor lighting system</a>
          </div>
        </div>
        <!-- end of item -->
        <!-- item -->
        <div class = "design-item">
          <div class = "design-img">
            <img src = "new-image/Pasted image.png" alt = "">
            <span><i class = "far fa-heart"></i> 22</span>
            <span>SOLAR POWER GENERATION</span>
          </div>
          <div class = "design-title">
            <a href = "#">Is a system of generating electricity by use of solar energies ,electricity and heat.</a>
          </div>
        </div>
        <!-- end of item -->
        <!-- item -->
        <div class = "design-item">
          <div class = "design-img">
            <img src = "new-image/Pasted image 1.png" alt = "">
            <span><i class = "far fa-heart"></i> 22</span>
            <span>Water pumping system</span>
          </div>
          <div class = "design-title">
            <a href = "#">this is a method of pumping water so that it can be distributed from one place to another.</a>
          </div>
        </div>
        <!-- end of item -->
        <!-- item -->
        <div class = "design-item">
          <div class = "design-img">
            <img src = "new-image/Pasted image 2.png" alt = "">
            <span><i class = "far fa-heart"></i> 22</span>
            <span>Solar mini grid</span>
          </div>
          <div class = "design-title">
            <a href = "#">are independent decentralised electricity networks that can function separately from a national grid.</a>
          </div>
        </div>
        <!-- end of item -->
        <!-- item -->
        <div class = "design-item">
          <div class = "design-img">
            <img src = "new-image/Pasted image 3.png" alt = "">
            <span><i class = "far fa-heart"></i> 22</span>
            <span>COMMERCIAL USE</span>
          </div>
          <div class = "design-title">
            <a href = "#">The Sun’s rays fall on the collector panel (a component of solar water heating system),</a>
          </div>
        </div>
        <!-- end of item -->
      </div>
