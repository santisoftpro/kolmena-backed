        ...
        <div class="card-deck" id="fakeshoe">
            <div class="card no-padding">
                <div id="carousel-1" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/banner-2.jpg" alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/about.jpg" alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/banner-1.jpg" alt="Third slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/banner-3.jpg" alt="fourth slide">
                      </div>
                    </div>
                    <a class="carousel-control-prev" href="#carousel-1" role="button" data-slide="prev">
                      <span class="carousel-control-fa-arrow-left" aria-hidden="true"></span>
                      <i class="fas fa-arrow-left arrow-icon"></i>
                      <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#carousel-1" role="button" data-slide="next">
                      <span class="carousel-control-fa-arrow-right" aria-hidden="true"></span>
                ...
                <div class="card-body mt-5">
                    <p class="card-title accessories-tittle">SOLAR PANELS</p>
            ...
            <div class="card no-padding">
                <div id="carousel-2" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/solar lights.jpg" alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/p7.jpg" alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/system controller.jpg" alt="Third slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 discover-welcome" src="kolmena/img/hero-1-5.jpg" alt="fourth slide">
                      </div>
                    </div>
                ...
                <div class="card-body mt-5">
                    <p class="card-title accessories-tittle">Integrated Solar Lights</p>
                    <p class="card-text accessories-text">
                        The Waterproof Integrated Solar Lamp have stable use characteristics.
                         The high-quality solar panel has high conversion rate, high efficiency output,
	...
	$(function () {
		$(document).scroll(function () {
	  		...
	  		if ($(document).scrollTop() > $nav.height()) {
		        $nav_img.attr("src","assets/images/niche-logo.png");
		    } else {
		        $nav_img.attr("src","assets/images/niche-logo.png");
		    }
		});
